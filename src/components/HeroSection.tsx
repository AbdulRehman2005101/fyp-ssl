      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2">
              ...
              <button className="px-8 py-4 bg-transparent border border-slate-700 text-slate-300 rounded-lg font-bold hover:border-[#0c5d14] hover:text-white transition-all duration-300 text-base">
                Documentation
              </button>
            </div>
          ...
          <div className="hidden lg:flex justify-center items-center">
            <div className="relative w-full max-w-lg h-[500px]">
              ...
              <div className="absolute top-4 right-4 bg-black/90 border border-[#0c5d14]/40 rounded-lg px-4 py-3 backdrop-blur">
                ...
                <div className="text-slate-400 text-xs">Nodes: <span className="text-[#14b857]">{networkNodes}</span></div>
              </div>
        ...
        <div className="mt-16 grid grid-cols-3 gap-6 max-w-3xl mx-auto">
          ...
          <div className="text-center">
            ...
            <div className="text-slate-500 text-sm">Verifications</div>
          </div>
          <div className="text-center">
