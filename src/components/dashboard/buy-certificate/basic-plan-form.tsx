...
import CsrGenerationDialog from "@/components/dashboard/dialogs/csr-generation-dialog";
import PurchaseConfirmDialog from "@/components/dashboard/dialogs/purchase-confirm-dialog";
...
export default function BasicPlanForm() {
  ...
  // Domain limits based on certificate type
  ...
  // Step 1: Generate CSR and create draft order
  ...
  // Step 2: Submit to SSL.com for validation
