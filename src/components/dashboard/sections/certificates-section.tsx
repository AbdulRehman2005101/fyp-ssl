...
import CertificateDetailsDialog from "@/components/dashboard/dialogs/certificate-details-dialog"
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case "pending_validation":
        return <Badge className="bg-yellow-600">Pending Validation</Badge>
      case "validating":
        return <Badge className="bg-blue-600">Validating</Badge>
      case "draft":
                    ...
                    <TableCell className="font-medium">
                      <div>
                        ...
                        {cert.certificateType === "wildcard" && (
                          <span className="text-xs text-blue-600 ml-2">(Wildcard)</span>
                        )}
                      </div>
                    </TableCell>
                    <TableCell>
