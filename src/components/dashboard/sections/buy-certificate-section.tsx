...
import FreePlanForm from "@/components/dashboard/buy-certificate/free-plan-form"
import BasicPlanForm from "@/components/dashboard/buy-certificate/basic-plan-form"
import EnterprisePlanForm from "@/components/dashboard/buy-certificate/enterprise-plan-form"
...
export default function BuyCertificateSection() {
  ...
  // Check if a plan is available for the user (current plan or higher)
        ...
        <CardContent className="space-y-4">
            ...
            {(["FREE", "STANDARD", "PREMIUM"] as const).map((plan) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className={`font-semibold ${!isAvailable ? "text-gray-500" : ""}`}>
                    {planConfig?.name}
                  </h3>
                  <p className={`text-sm mt-1 ${!isAvailable ? "text-gray-400" : "text-muted-foreground"}`}>
          ...
          {hasPlan && planData && (
            <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <h4 className="font-semibold text-blue-900 mb-2">Your Plan Usage</h4>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                <div>
                  <span className="text-blue-700">Basic Certificates: </span>
                ...
                {planData.plan.features.supportsSAN && (
                  <div>
                    <span className="text-blue-700">SAN Certificates: </span>
                    <span className="font-semibold">
                ...
                {planData.plan.features.supportsWildcard && (
                  <div>
                    <span className="text-blue-700">Wildcard Certificates: </span>
                    <span className="font-semibold">
