...
import PlanPurchaseDialog from "@/components/dashboard/dialogs/plan-purchase-dialog";
...
export default function YourPlanSection() {
  ...
  // Add this useEffect to handle Stripe redirects
  // In YourPlanSection component - IMPROVED VERSION
  useEffect(() => {
  ...
  const handlePlanSelect = async (
    ...
    try {
      ...
      if (result.success) {
        ...
        // 🚀 THIS IS THE REDIRECT TO STRIPE
