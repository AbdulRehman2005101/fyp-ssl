                ...
                <div className="flex flex-col space-y-2 mt-8 px-4">
                  {navigation.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="text-lg font-medium text-white hover:text-[#0c5d14] py-3 px-4 rounded-xl hover:bg-white/10 transition-all duration-200"
        ...
        <div className="hidden lg:flex lg:gap-x-2">
          {navigation.map((item) => (
            <a
              key={item.name}
              href={item.href}
              className="px-4 py-2 text-sm font-semibold text-white hover:text-[#18a526] rounded-xl hover:bg-white/10 transition-all duration-200"
              onClick={(e) => handleNavClick(e, item.href)}
            >
              {item.name}
            </a>
