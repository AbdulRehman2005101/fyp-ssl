      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div className="p-6 rounded-xl border border-white/10 bg-white/5">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <Mail className="h-5 w-5 text-[#0c5d14]" />
                  <span className="text-gray-300">contact@pkichain.com</span>
                </div>
                <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-3">
                  <Building className="h-5 w-5 text-[#0c5d14]" />
          ...
          <div className="relative">
            <div className="relative p-8 rounded-2xl border border-white/10 bg-black">
              ...
              <form onSubmit={handleSubmit} className="relative z-10 space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full py-4 bg-[#0c5d14] text-white rounded-xl font-semibold shadow-lg hover:shadow-[#0c5d14]/25 hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2"
                >
