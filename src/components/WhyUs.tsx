      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            <span className="text-[#0c5d14]">unbreakable security</span> and{" "}
            <span className="text-[#0c5d14]">decentralized trust</span>.
          </p>
        </div>
        ...
        <div  className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
          {reasons.map((reason, index) => (
            <div
              key={index}
              className="group relative p-8 rounded-xl border border-gray-800 bg-linear-to-br from-gray-900/50 to-black hover:border-[#0c5d14]/50 transition-all duration-500 cursor-pointer"
            >
              <div className="flex items-start gap-4 mb-4">
                <div className="shrink-0">
                  <div className="p-3 rounded-lg border border-[#0c5d14]/30 text-[#0c5d14] group-hover:border-[#0c5d14] group-hover:text-[#0c5d14] transition-all duration-300">
                    {reason.icon}
                  </div>
                </div>
                <div className="flex-1">
                  ...
                  <div className="inline-block px-3 py-1 rounded-full bg-[#0c5d14]/10 border border-[#0c5d14]/20">
                    <span className="text-xs font-semibold text-[#0c5d14] flex items-center justify-center">{reason.highlight}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-white/10 group-hover:border-[#0c5d14]/30 transition-colors duration-300">
                <span className="text-xs text-gray-500 group-hover:text-[#0c5d14] transition-colors duration-300">
                  Benefit #{index + 1}
                </span>
                <div className="flex items-center gap-1">
                  <CheckCircle className="h-4 w-4 text-[#0c5d14] opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                </div>
              </div>
